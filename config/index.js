export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx070421b3fba32001",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "659263a6332379a3c6669068a0ec5b4a",
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "JQRFb6kRTxHJhhCT6YKj20rGpADcNg6DKjuN0ZXjzW0",
      // 所在省份
      province: "重庆",
      // 所在城市
      city: "重庆",
      ...
      openUrl: "https://s.weibo.com/top/summary/?sudaref=m.baidu.com",
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        {"keyword": "marry_day", date: "2022-04-06"},
        // 退伍日
  ...
  SLOT_LIST: [
    ...
    {"keyword": "lover_prattle", contents: [
      "我永远为人类感情里的真挚、真诚、热烈而感动，如果没办法拥有，我将永远为别人热泪盈眶。",
    ]},
    // 你可以不断按格式往下增加
    // ...
  ],
